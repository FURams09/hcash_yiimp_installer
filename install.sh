...
' | sudo -E tee /etc/nginx/blockuseragents.rules >/dev/null 2>&1
    ...
    output " Installing HCash_yiimp"
    output ""
    output "Grabbing HCash_yiimp from Github, building files and setting file structure."
    output ""
    #Generating Random Password for stratum
    blckntifypass=`cat /dev/urandom | tr -dc 'a-zA-Z0-9' | fold -w 32 | head -n 1`
    cd ~
    git clone https://github.com/FURams09/Hcash_yiimp.git
    ...
    sudo make
    cd $HOME/Hcash_yiimp
    sudo sed -i 's/AdminRights/'$admin_panel'/' $HOME/Hcash_yiimp/web/yaamp/modules/site/SiteController.php
...
define('"'"'YAAMP_SITE_NAME'"'"', '"'"'HCash Pool'"'"');
